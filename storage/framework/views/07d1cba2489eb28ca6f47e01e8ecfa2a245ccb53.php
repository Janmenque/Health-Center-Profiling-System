    ...
    <div class="row">
        ...
        <div class="col-xxl-3 col-sm-6 cdx-xxl-50">
            <div class="card sale-revenue">
                ...
                <div class="card-body progressCounter">
                    <h2><?php echo e(env('CURRENCY_SYMBOL').$result['totalIncome']); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-xxl-3 col-sm-6 cdx-xxl-50">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u538007105/domains/capstonesystem.website/public_html/resources/views/dashboard/super_admin.blade.php ENDPATH**/ ?>